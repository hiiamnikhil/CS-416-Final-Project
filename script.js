...
d3.csv("bog_bodies.csv").then(data => {
  ...
  svg.selectAll(".label")
    .data(data)
    .enter().append("text")
    .attr("x", function (d) { return x(d.percentage) + 5; })
  ...
  svg.append("text")
    ...
    .style("font-weight", "bold")
    .style("font-family", "sans-serif")
    .text("NASDAQ 100 (by Weight Percentage) Stocks");
  ...
  svg.append("text")
    ...
    .style("font-family", "sans-serif")
    .html("<a href='https://www.visualcapitalist.com/cp/nasdaq-100-companies-by-weight/'>Source: Charted: Companies in the Nasdaq 100, by Weight</a>");
